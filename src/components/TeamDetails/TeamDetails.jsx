      ...
      <div className="middle-contaiiner">
        ...
        <div className="stadium">
          <div className="stadium-details">
            <h2>
              Stadium Name: <br /> {data.team.venue.name}
            </h2>
            <h2>
              City: <br /> {data.team.venue.city}
            </h2>
            <h2>
              Address: <br /> {data.team.venue.address}
            </h2>
            <h2>
              Stadium Capacity: <br /> {data.team.venue.capacity}
            </h2>
            <h2>
              Surface: <br /> {data.team.venue.surface}
            </h2>
          </div>
        </div>
      </div>
